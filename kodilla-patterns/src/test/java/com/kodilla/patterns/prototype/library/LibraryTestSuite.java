...
public class LibraryTestSuite {
    ...
    void testGetBooks(){
        ...
        //When - cleaning Library
        //System.out.println(library.getBooks().contains(new Book("King Arthur 1", "J. R. R. Tolkien", LocalDate.of(1963, 2, 8))));
        library.getBooks().remove(new Book("King Arthur 1", "J. R. R. Tolkien", LocalDate.of(1963, 2, 8)));
        ...
        assertEquals(4, swallowCopy.getBooks().size());
        assertEquals(5, deepCopy.getBooks().size());
        assertEquals(swallowCopy.getBooks(), library.getBooks());
        assertNotEquals(deepCopy.getBooks(), library.getBooks());
    }
